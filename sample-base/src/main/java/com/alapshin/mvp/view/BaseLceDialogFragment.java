...
public abstract class BaseLceDialogFragment<D, V extends MvpView, P extends Presenter<V>>
        extends MvpLceDialogFragment<D, V, P> implements LifecycleProvider<FragmentEvent> {
